...
But unlike in Rust, linear values **cannot be dropped.** Instead, they have to be consumed according to their type. _(Also, see [auto-cleanup](./types/auto_cleanup.md).)_
